...
def mens_releases_page():
    ...
    return render_template('customer/catalog.html', title=title, collection=collection)
...
def womens_releases_page():
    ...
    return render_template('customer/catalog.html', title=title, current_user=current_user, collection=collection)
...
def display_product(id):
    ...
    return render_template('customer/product.html', current_user=current_user, shoe=shoe)
